...
public class ChylsyMarableRinkyDooflingyCompany {
    ...
    /**
     * This method displays the user welcome.
     */
     ...
     * program is executed and the if statements run certain parts depending
     * on the user's input. At the end, the program displays the thank you
     * message.
     */
